...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        'departamento_id' => $dep1->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => $dep2->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => $dep3->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => $dep4->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => $dep5->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => $dep6->id, 'rol_id' => $medico->id, 'password' => '1234']);
        $usuario->save();
        ...
        'departamento_id' => null, 'rol_id' => $paciente->id, 'password' => '$2y$10$lmh4A90v470PHSpmBXd6T.PaiyszLJNr1LCpby6IN4x50XXRImyQO']);
        $User->save();
        $User= new User(['dni' => '00000003Y','nombre' => 'Yael', 'apellidos' =>'Durán Izquierdo',
